...
- 候选 `69cd1c1faf4da9fe375990554078403f85737d29` 冻结后，仅运行一次
  `values15-20260802T210307Z`。15 条均有 usage，transport 失败与自动重试为 `0`，没有补跑或
  据结果修改候选。
- 基线 → 本轮为正确 `9/15 → 9/15`、成功类 `1/7 → 1/7`、执行 `7/7 → 7/7`、介入
  `7/15 → 7/15`；有限字段值采集未新增提升。五类正确仍为 `1/7、2/2、2/2、2/2、2/2`。
- prompt / completion / total usage 为 `27426/1642/29068 → 29775/1446/31221`；越权与全部
  非成功 SQL 执行均为 `0`，业务库前后 SHA-256 同为 `2401b221…85b33`，报告 SHA-256 为
  `da0e9ee5…7cea0f`。
- 精确推送 head `dfbd284220f8f1c45194920a521b77d2d248a98b` 经
  [PR #35](https://github.com/suuny-ab/auditable-nl2sql-agent/pull/35) 三路 CI 全绿后 squash 为
  `e7686bbae6e2ebff6d0be0510a7802d1dae2fba7`；main CI run `30767171976` 再次三路全绿，未部署。
